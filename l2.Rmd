...
a) En una ciudad están interesados en estimar el peso promedio de los varones adultos. Para eso se recolectó una muestra aleatoria $n$ del peso de varones adultos, los siguientes datos.
...
Los resultados son resumidos mediante la siguiente tabla:
