...
Este tipo de problemas los podemos resolver usando digramas de Venn:
...
Debemos darnos cuenta que el ejercicio nos esta preguntando por una probabilidad del complemento, esto es: $P(J^c \cap L^c)$, si usamos las leyes de Morgan, el problema es resuelto, veamos:
...
Los datos de color rojo son los que provee el problema, los demas son calculados usando complementos. 
