...
Si X es una variable aleatoria Binomial de paramétros $n$ y $p$ podemos escribir:
...
b) Calcular la probabilidad de observar 47 vecez cruz usando una aproximación Normal a la distribución Binomial:
...
$P(Y=47)=P(46.5 < Y < 47.5)$

Entonces,

$$P(46.5 < Y < 47.5)=P(Y < 47.5) - P(Y < 46.5)$$
