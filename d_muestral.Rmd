...
> Ilustración de como funciona el Teorema del límite central
...
#### Este resultado que está bien cerca de la media poblacional. 

#### 2. La desviación estándar de la media muestral es 2.806 mientras que 

#### $\sigma_{\bar{X}}=\dfrac{\sigma}{\sqrt{n}}=$ `r round(sd(d_mean),2)`. 

#### Notamos que ambos valores, tando el de la media y el de la desviación estandar están bien próximos a los valores poblacionales. 
