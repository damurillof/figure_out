...
**El Coeficiente de Variación CV** que se define como $CV=\frac{s}{|\bar{x}|}*100 \%$. Si el CV es mayor que 30 % la muestra es bastante variable y si CV es menor del 10 % entonces existe poca variabilidad. Para el ejemplo el CV para la muestra uno es 35.77 y para la muestra 2 es 7.87. Hagamos los cálculos en RStudio
