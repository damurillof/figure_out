...
#### <span style="color:red">Ayuda: </span> En algún momento del ejercicio debe asumir independencia de eventos y usar la siguiente definición. 

#### Definición: Si $A$ y $B$  son eventos independientes, entonces $P(A \cap B) = P(A)\cdot P(B)$.
