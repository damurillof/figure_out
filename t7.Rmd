...
####  **2.** El “Craps”, también conocido como  “Pase Inglés” es un famoso juego de azar que consiste en apostar al resultado de la suma al lanzar un par de dados legales. Esté juego tiene varias reglas, pero si las asumimos, el problema se hace muy complicado. Nosotros solo vamos a definir dos reglas para simplificar el problema:
