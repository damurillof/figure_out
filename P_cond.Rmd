...
Nos dice con qué fprobabilidad  sucede el evento $A$ dado que el evento $B$ ha sucedido, y se escribe como  $P(A | B)$. Cuando sabemos con qué frecuencia ocurre $B$ dado que $A$ sucede, se escribe  $P(B | A)$, y cuán probable que los eventos $A$ y $B$ ocurran por separado.
...
**P(Fuego | Humo)** significa con qué frecuencia hay fuego cuando vemos humo.
**P(Humo | Fuego)** significa la frecuencia con la que vemos humo cuando hay un incendio.
