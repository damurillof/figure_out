...
es llamada la fórmula de la probabilidad total.
...
¿Cómo verificamos que A y B son independientes?, solo debemos el producto de sus probabilidades es igual a la probabilidad de la intersección. Veamos
