...
#### **Límite Inferior**: $\bar{X} - t_{(\frac{\alpha}{2},n-1)}{\sqrt{n}}$

#### **Límite Superior**: $\bar{X} + t_{(\frac{\alpha}{2},n-1)}{\sqrt{n}}$

#### Por tanto, el intervalo para la media $\mu$ es

#### $$\Big(\bar{X} - t_{(\frac{\alpha}{2},n-1)}{\sqrt{n}} , \bar{X} + t_{(\frac{\alpha}{2},n-1)}{\sqrt{n}}\Big)$$
